let N;      // number of full tubes / colors
let K;      // number of empty tubes
let H;      // max height (items) of each tubes
...
function setNumberOfRowsAndCols(){
    ...
    // and the size of the items (marbles) to be use, to maximize the space used by table of the game, and make it
    // fit the whole page.
...
function addcontainer_callback(){
    // The minimum number of empty tubes to have to be able to solve EVERY istance of the game 
